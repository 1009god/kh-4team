	...
	public void addInterceptors(InterceptorRegistry registry) {
		...
		registry.addInterceptor(memInterceptor)
					.addPathPatterns(//인터셉터가 감시할 주소
							"${pageContext.request.contextPath}/mem/*",//회원 전체
							"${pageContext.request.contextPath}/board/write", //글쓰기
							"${pageContext.request.contextPath}/mypage/*",
							"${pageContext.request.contextPath}/doran-q/write"
					)
					.excludePathPatterns(//위의 주소에서 제외할 주소 (비회원)
							"${pageContext.request.contextPath}/mem/join*",//회원가입
							"${pageContext.request.contextPath}/mem/login",//로그인
							"${pageContext.request.contextPath}/mem/findEmail",//이메일 찾기
							"${pageContext.request.contextPath}/mem/findPw",//비밀번호 찾기
							"${pageContext.request.contextPath}/mypage/goodbye_result", //탈퇴 결과
							"${pageContext.request.contextPath}/doran-q/list" //1:1 문의 목록
					);
...
//							);
		...
		registry.addInterceptor(ownerCheckInterceptor2)
					.addPathPatterns(
							"${pageContext.request.contextPath}/board/reply/edit",
							"${pageContext.request.contextPath}/board/reply/delete"
					);
